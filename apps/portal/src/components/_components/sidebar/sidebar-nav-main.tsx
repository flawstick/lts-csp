            ...
            return (
              <SidebarMenuItem key={item.key}>
                <SidebarMenuButton
                  ...
                  className="h-9 rounded-xl border border-sidebar-border/70 bg-sidebar-accent/30 text-[15px] transition data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium hover:bg-sidebar-accent/80 group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-0 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0"
                >
                  ...
                  <span className="min-w-0 max-w-[10rem] truncate whitespace-nowrap group-data-[collapsible=icon]:hidden">
                    {item.title}
                  </span>
