...
export default function OrgBillingPage() {
  ...
  const invoicesQuery = api.invoice.list.useQuery(
    { orgId: currentOrg?.id, pageSize: 50 },
    { enabled: !!currentOrg }
  )
  ...
  const organisationsQuery = api.invoice.getOrganisations.useQuery(undefined, {
    enabled: memberInfo?.isGlobalAdmin,
  })
  ...
  const isGlobalAdmin = memberInfo?.isGlobalAdmin || invoicesQuery.data?.isGlobalAdmin
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                {isGlobalAdmin
                  ? "Manage invoices for all organisations"
                  : "View your invoices and payment history"}
              </p>
            </div>
            <div className="flex items-center gap-2">
              {memberInfo && (
                <Badge variant={memberInfo.isGlobalAdmin ? "default" : memberInfo.role === "owner" ? "default" : "secondary"}>
                ...
                <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[500px]">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Create a new invoice for an organisation
                      </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                      ...
                      <div className="grid gap-2">
                        ...
                        <Textarea
                          ...
                          placeholder="Monthly subscription - Professional plan"
                          rows={2}
                        />
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                    ...
                    <DialogFooter>
                      ...
                      <Button
                        ...
                        disabled={createInvoiceMutation.isPending || !invoiceNumber || !amount}
                      >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {isGlobalAdmin
                  ? "All invoices across organisations"
                  : "Your organisation's invoices"}
              </CardDescription>
            </CardHeader>
            <CardContent>
