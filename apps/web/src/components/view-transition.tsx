 ...
 * alongside text. Uses the `morph` recipe (controlled duration + mid-animation
 * blur) because `text-morph` hides the old snapshot, which would make the icon
 * disappear abruptly.
 */
