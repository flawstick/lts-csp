      ...
      <div className="mx-auto">
        <div >
          <div className="container mx-auto">
            <h1 ref={headingRef} className="text-4xl text-left font-bold tracking-tight sm:text-5xl">Not everything powerful <br /> has to look complicated</h1>
            <p ref={textRef} className="mt-4 text-lg text-muted-foreground text-left">Explore the key features that make our platform a game-changer for businesses of all sizes.</p>
          </div>
          <div
            ref={sliderRef}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              {dashboardTabs.map((tab, index) => {
                ...
                return (
                  <div
                    key={tab.id}
                    className={`absolute transition-all duration-500 ease-in-out rounded-2xl border-4 ${isActive ? 'border-border' : 'border-border/50'} ${isActive ? 'shadow-2xl' : 'shadow-md'}`}
                    style={{
